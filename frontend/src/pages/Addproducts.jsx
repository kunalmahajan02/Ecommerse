...
const Addproducts = () => {
    ...
    const handleSubmitfinal = async(e) => {
        ...
        try {
            const a = await axios.post(`${process.env.REACT_APP_BACKENDURL1}/addproduct`, data);
            console.log(a);
        } catch (e) {
            console.log(e);
        }
    ...
    return (
        <Form onSubmit={handleSubmitfinal}>
            ...
            <Inner className="mb-3">
                <label>Give Products Category Id</label>
                <input style={{ border: "1.5px solid black" }}
                    type="text"
                    className="form-control"
                    placeholder="Description"
                    id="5"
                    onChange={() => { setcategoryid(document.getElementById("5").value) }} />
            </Inner>
